...
namespace ReferendumService.Services;

/// <summary>
/// Encapsula la comunicación HTTP entre ReferendumService y AuditService.
/// </summary>
/// <remarks>
/// La auditoría se considera secundaria. Un fallo de AuditService no debe
/// invalidar una operación administrativa ya completada.
/// </remarks>
public sealed class AuditClient
{
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> cuando AuditService acepta el evento; en caso
        ...
        CancellationToken ct)
    {
        ...
        {
            // La auditoría no debe deshacer una modificación ya persistida.
            _logger.LogWarning(
                ex,
