...
/// <summary>
/// Encapsula la comunicación HTTP de VoteService con AuditService.
/// </summary>
/// <remarks>
/// El registro de auditoría se ejecuta como una operación secundaria.
/// Si AuditService no está disponible, el voto no debe considerarse fallido.
/// </remarks>
public sealed class AuditClient
{
    ...
    /// </param>
    /// <param name="logger">
    /// Servicio utilizado para registrar fallos de comunicación.
    /// </param>
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> cuando AuditService acepta el evento;
        ...
        CancellationToken ct)
    {
        ...
        {
            // La auditoría no debe invalidar una operación de voto que ya fue
            // procesada correctamente por el dominio principal.
            _logger.LogWarning(
                ex,
